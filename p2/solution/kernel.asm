...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 47 59 10 80 	movl   $0x80105947,0x14(%eax)
  p->context = (struct context*)sp;
...
801041fb:	68 07 7c 10 80       	push   $0x80107c07
...
80104c04:	68 d8 79 10 80       	push   $0x801079d8
...
80104c1c:	68 d7 79 10 80       	push   $0x801079d7
...
80104c31:	68 cb 79 10 80       	push   $0x801079cb
...
80104c4f:	68 da 79 10 80       	push   $0x801079da
80104c54:	e8 27 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c59:	83 ec 0c             	sub    $0xc,%esp
80104c5c:	68 bc 79 10 80       	push   $0x801079bc
...
8010505d:	58                   	pop    %eax
8010505e:	5a                   	pop    %edx
8010505f:	68 d8 79 10 80       	push   $0x801079d8
...
80105078:	68 d7 79 10 80       	push   $0x801079d7
...
80105847:	e8 24 e1 ff ff       	call   80103970 <myproc>
    ...
    // Fetch the arguments passed to the system call
    if (argptr(0, &parentbuf, sizeof(char*)) < 0 ||
8010584c:	83 ec 04             	sub    $0x4,%esp
    struct proc *p = myproc();  // Get the current process
8010584f:	89 c3                	mov    %eax,%ebx
    if (argptr(0, &parentbuf, sizeof(char*)) < 0 ||
80105851:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105854:	6a 04                	push   $0x4
80105856:	50                   	push   %eax
80105857:	6a 00                	push   $0x0
80105859:	e8 12 f1 ff ff       	call   80104970 <argptr>
8010585e:	83 c4 10             	add    $0x10,%esp
80105861:	85 c0                	test   %eax,%eax
80105863:	0f 88 bf 00 00 00    	js     80105928 <sys_getparentname+0xe8>
        argptr(1, &childbuf, sizeof(char*)) < 0 ||
...
8010587e:	0f 88 a4 00 00 00    	js     80105928 <sys_getparentname+0xe8>
...
8010588d:	e8 8e f0 ff ff       	call   80104920 <argint>
        argptr(1, &childbuf, sizeof(char*)) < 0 ||
80105892:	83 c4 10             	add    $0x10,%esp
80105895:	85 c0                	test   %eax,%eax
80105897:	0f 88 8b 00 00 00    	js     80105928 <sys_getparentname+0xe8>
...
801058a6:	e8 75 f0 ff ff       	call   80104920 <argint>
        argint(2, &parentbufsize) < 0 ||
801058ab:	83 c4 10             	add    $0x10,%esp
801058ae:	85 c0                	test   %eax,%eax
801058b0:	78 76                	js     80105928 <sys_getparentname+0xe8>
        return -1;
    }

    // Check if the buffer pointers are null or if the sizes are invalid
    if (!parentbuf || !childbuf || parentbufsize <= 0 || childbufsize <= 0) {
801058b2:	8b 4d e8             	mov    -0x18(%ebp),%ecx
801058b5:	85 c9                	test   %ecx,%ecx
801058b7:	74 6f                	je     80105928 <sys_getparentname+0xe8>
801058b9:	8b 45 ec             	mov    -0x14(%ebp),%eax
801058bc:	85 c0                	test   %eax,%eax
801058be:	74 68                	je     80105928 <sys_getparentname+0xe8>
801058c0:	8b 55 f0             	mov    -0x10(%ebp),%edx
801058c3:	85 d2                	test   %edx,%edx
801058c5:	7e 61                	jle    80105928 <sys_getparentname+0xe8>
801058c7:	8b 55 f4             	mov    -0xc(%ebp),%edx
801058ca:	85 d2                	test   %edx,%edx
801058cc:	7e 5a                	jle    80105928 <sys_getparentname+0xe8>
        return -1;
    }

    // Copy the current process name to childbuf
    safestrcpy(childbuf, p->name, childbufsize);
801058ce:	83 ec 04             	sub    $0x4,%esp
801058d1:	52                   	push   %edx
801058d2:	8d 53 6c             	lea    0x6c(%ebx),%edx
801058d5:	52                   	push   %edx
801058d6:	50                   	push   %eax
801058d7:	e8 44 ef ff ff       	call   80104820 <safestrcpy>

    // Check if the process has a parent, and copy the parent's name to parentbuf
    if (p->parent) {
801058dc:	8b 43 14             	mov    0x14(%ebx),%eax
801058df:	83 c4 10             	add    $0x10,%esp
801058e2:	85 c0                	test   %eax,%eax
801058e4:	74 22                	je     80105908 <sys_getparentname+0xc8>
        safestrcpy(parentbuf, p->parent->name, parentbufsize);
801058e6:	83 ec 04             	sub    $0x4,%esp
801058e9:	83 c0 6c             	add    $0x6c,%eax
801058ec:	ff 75 f0             	push   -0x10(%ebp)
801058ef:	50                   	push   %eax
801058f0:	ff 75 e8             	push   -0x18(%ebp)
801058f3:	e8 28 ef ff ff       	call   80104820 <safestrcpy>
801058f8:	83 c4 10             	add    $0x10,%esp
    } else {
        safestrcpy(parentbuf, "No Parent", parentbufsize);
    }
...
8010590b:	ff 75 f0             	push   -0x10(%ebp)
8010590e:	68 1d 7a 10 80       	push   $0x80107a1d
80105913:	ff 75 e8             	push   -0x18(%ebp)
80105916:	e8 05 ef ff ff       	call   80104820 <safestrcpy>
}
8010591b:	8b 5d fc             	mov    -0x4(%ebp),%ebx
        safestrcpy(parentbuf, "No Parent", parentbufsize);
...
8010592d:	eb ce                	jmp    801058fd <sys_getparentname+0xbd>
...
801059ae:	00 00 ef 
  initlock(&tickslock, "time");
801059b1:	68 27 7a 10 80       	push   $0x80107a27
...
80105a34:	ff 24 85 d0 7a 10 80 	jmp    *-0x7fef8530(,%eax,4)
...
80105b15:	68 8c 7a 10 80       	push   $0x80107a8c
...
80105b67:	68 34 7a 10 80       	push   $0x80107a34
...
80105c83:	68 58 7a 10 80       	push   $0x80107a58
80105c88:	e8 13 aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105c8d:	83 c4 14             	add    $0x14,%esp
80105c90:	68 2c 7a 10 80       	push   $0x80107a2c
...
80105d3c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105d3f:	bf 50 7b 10 80       	mov    $0x80107b50,%edi
...
80105e27:	6a 00                	push   $0x0
  jmp alltraps
80105e29:	e9 01 fb ff ff       	jmp    8010592f <alltraps>
...
80105e30:	6a 01                	push   $0x1
  jmp alltraps
80105e32:	e9 f8 fa ff ff       	jmp    8010592f <alltraps>
...
80105e39:	6a 02                	push   $0x2
  jmp alltraps
80105e3b:	e9 ef fa ff ff       	jmp    8010592f <alltraps>
...
80105e42:	6a 03                	push   $0x3
  jmp alltraps
80105e44:	e9 e6 fa ff ff       	jmp    8010592f <alltraps>
...
80105e4b:	6a 04                	push   $0x4
  jmp alltraps
80105e4d:	e9 dd fa ff ff       	jmp    8010592f <alltraps>
...
80105e54:	6a 05                	push   $0x5
  jmp alltraps
80105e56:	e9 d4 fa ff ff       	jmp    8010592f <alltraps>
...
80105e7d:	6a 0a                	push   $0xa
  jmp alltraps
80105e7f:	e9 ab fa ff ff       	jmp    8010592f <alltraps>
...
80105e84:	6a 0b                	push   $0xb
  jmp alltraps
80105e86:	e9 a4 fa ff ff       	jmp    8010592f <alltraps>
...
80105e8b:	6a 0c                	push   $0xc
  jmp alltraps
80105e8d:	e9 9d fa ff ff       	jmp    8010592f <alltraps>
...
80105e99:	6a 0e                	push   $0xe
  jmp alltraps
80105e9b:	e9 8f fa ff ff       	jmp    8010592f <alltraps>
...
80105eb2:	6a 11                	push   $0x11
  jmp alltraps
80105eb4:	e9 76 fa ff ff       	jmp    8010592f <alltraps>
...
80105ebb:	6a 12                	push   $0x12
  jmp alltraps
80105ebd:	e9 6d fa ff ff       	jmp    8010592f <alltraps>
...
80105ec4:	6a 13                	push   $0x13
  jmp alltraps
80105ec6:	e9 64 fa ff ff       	jmp    8010592f <alltraps>
...
80105ecd:	6a 14                	push   $0x14
  jmp alltraps
80105ecf:	e9 5b fa ff ff       	jmp    8010592f <alltraps>
...
80105ed6:	6a 15                	push   $0x15
  jmp alltraps
80105ed8:	e9 52 fa ff ff       	jmp    8010592f <alltraps>
...
80105edf:	6a 16                	push   $0x16
  jmp alltraps
80105ee1:	e9 49 fa ff ff       	jmp    8010592f <alltraps>
...
80105ee8:	6a 17                	push   $0x17
  jmp alltraps
80105eea:	e9 40 fa ff ff       	jmp    8010592f <alltraps>
...
80105ef1:	6a 18                	push   $0x18
  jmp alltraps
80105ef3:	e9 37 fa ff ff       	jmp    8010592f <alltraps>
...
80105efa:	6a 19                	push   $0x19
  jmp alltraps
80105efc:	e9 2e fa ff ff       	jmp    8010592f <alltraps>
...
80105f03:	6a 1a                	push   $0x1a
  jmp alltraps
80105f05:	e9 25 fa ff ff       	jmp    8010592f <alltraps>
...
80105f0c:	6a 1b                	push   $0x1b
  jmp alltraps
80105f0e:	e9 1c fa ff ff       	jmp    8010592f <alltraps>
...
80105f15:	6a 1c                	push   $0x1c
  jmp alltraps
80105f17:	e9 13 fa ff ff       	jmp    8010592f <alltraps>
...
80105f1e:	6a 1d                	push   $0x1d
  jmp alltraps
80105f20:	e9 0a fa ff ff       	jmp    8010592f <alltraps>
...
80105f27:	6a 1e                	push   $0x1e
  jmp alltraps
80105f29:	e9 01 fa ff ff       	jmp    8010592f <alltraps>
...
80105f30:	6a 1f                	push   $0x1f
  jmp alltraps
80105f32:	e9 f8 f9 ff ff       	jmp    8010592f <alltraps>
...
80105f39:	6a 20                	push   $0x20
  jmp alltraps
80105f3b:	e9 ef f9 ff ff       	jmp    8010592f <alltraps>
...
80105f42:	6a 21                	push   $0x21
  jmp alltraps
80105f44:	e9 e6 f9 ff ff       	jmp    8010592f <alltraps>
...
80105f4b:	6a 22                	push   $0x22
  jmp alltraps
80105f4d:	e9 dd f9 ff ff       	jmp    8010592f <alltraps>
...
80105f54:	6a 23                	push   $0x23
  jmp alltraps
80105f56:	e9 d4 f9 ff ff       	jmp    8010592f <alltraps>
...
80105f5d:	6a 24                	push   $0x24
  jmp alltraps
80105f5f:	e9 cb f9 ff ff       	jmp    8010592f <alltraps>
...
80105f66:	6a 25                	push   $0x25
  jmp alltraps
80105f68:	e9 c2 f9 ff ff       	jmp    8010592f <alltraps>
...
80105f6f:	6a 26                	push   $0x26
  jmp alltraps
80105f71:	e9 b9 f9 ff ff       	jmp    8010592f <alltraps>
...
80105f78:	6a 27                	push   $0x27
  jmp alltraps
80105f7a:	e9 b0 f9 ff ff       	jmp    8010592f <alltraps>
...
80105f81:	6a 28                	push   $0x28
  jmp alltraps
80105f83:	e9 a7 f9 ff ff       	jmp    8010592f <alltraps>
...
80105f8a:	6a 29                	push   $0x29
  jmp alltraps
80105f8c:	e9 9e f9 ff ff       	jmp    8010592f <alltraps>
...
80105f93:	6a 2a                	push   $0x2a
  jmp alltraps
80105f95:	e9 95 f9 ff ff       	jmp    8010592f <alltraps>
...
80105f9c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f9e:	e9 8c f9 ff ff       	jmp    8010592f <alltraps>
...
80105fa5:	6a 2c                	push   $0x2c
  jmp alltraps
80105fa7:	e9 83 f9 ff ff       	jmp    8010592f <alltraps>
...
80105fae:	6a 2d                	push   $0x2d
  jmp alltraps
80105fb0:	e9 7a f9 ff ff       	jmp    8010592f <alltraps>
...
80105fb7:	6a 2e                	push   $0x2e
  jmp alltraps
80105fb9:	e9 71 f9 ff ff       	jmp    8010592f <alltraps>
...
80105fc0:	6a 2f                	push   $0x2f
  jmp alltraps
80105fc2:	e9 68 f9 ff ff       	jmp    8010592f <alltraps>
...
80105fc9:	6a 30                	push   $0x30
  jmp alltraps
80105fcb:	e9 5f f9 ff ff       	jmp    8010592f <alltraps>
...
80105fd2:	6a 31                	push   $0x31
  jmp alltraps
80105fd4:	e9 56 f9 ff ff       	jmp    8010592f <alltraps>
...
80105fdb:	6a 32                	push   $0x32
  jmp alltraps
80105fdd:	e9 4d f9 ff ff       	jmp    8010592f <alltraps>
...
80105fe4:	6a 33                	push   $0x33
  jmp alltraps
80105fe6:	e9 44 f9 ff ff       	jmp    8010592f <alltraps>
...
80105fed:	6a 34                	push   $0x34
  jmp alltraps
80105fef:	e9 3b f9 ff ff       	jmp    8010592f <alltraps>
...
80105ff6:	6a 35                	push   $0x35
  jmp alltraps
80105ff8:	e9 32 f9 ff ff       	jmp    8010592f <alltraps>
...
80105fff:	6a 36                	push   $0x36
  jmp alltraps
80106001:	e9 29 f9 ff ff       	jmp    8010592f <alltraps>
...
80106008:	6a 37                	push   $0x37
  jmp alltraps
8010600a:	e9 20 f9 ff ff       	jmp    8010592f <alltraps>
...
80106011:	6a 38                	push   $0x38
  jmp alltraps
80106013:	e9 17 f9 ff ff       	jmp    8010592f <alltraps>
...
8010601a:	6a 39                	push   $0x39
  jmp alltraps
8010601c:	e9 0e f9 ff ff       	jmp    8010592f <alltraps>
...
80106023:	6a 3a                	push   $0x3a
  jmp alltraps
80106025:	e9 05 f9 ff ff       	jmp    8010592f <alltraps>
...
8010602c:	6a 3b                	push   $0x3b
  jmp alltraps
8010602e:	e9 fc f8 ff ff       	jmp    8010592f <alltraps>
...
80106035:	6a 3c                	push   $0x3c
  jmp alltraps
80106037:	e9 f3 f8 ff ff       	jmp    8010592f <alltraps>
...
8010603e:	6a 3d                	push   $0x3d
  jmp alltraps
80106040:	e9 ea f8 ff ff       	jmp    8010592f <alltraps>
...
80106047:	6a 3e                	push   $0x3e
  jmp alltraps
80106049:	e9 e1 f8 ff ff       	jmp    8010592f <alltraps>
...
80106050:	6a 3f                	push   $0x3f
  jmp alltraps
80106052:	e9 d8 f8 ff ff       	jmp    8010592f <alltraps>
...
80106059:	6a 40                	push   $0x40
  jmp alltraps
8010605b:	e9 cf f8 ff ff       	jmp    8010592f <alltraps>
...
80106062:	6a 41                	push   $0x41
  jmp alltraps
80106064:	e9 c6 f8 ff ff       	jmp    8010592f <alltraps>
...
8010606b:	6a 42                	push   $0x42
  jmp alltraps
8010606d:	e9 bd f8 ff ff       	jmp    8010592f <alltraps>
...
80106074:	6a 43                	push   $0x43
  jmp alltraps
80106076:	e9 b4 f8 ff ff       	jmp    8010592f <alltraps>
...
8010607d:	6a 44                	push   $0x44
  jmp alltraps
8010607f:	e9 ab f8 ff ff       	jmp    8010592f <alltraps>
...
80106086:	6a 45                	push   $0x45
  jmp alltraps
80106088:	e9 a2 f8 ff ff       	jmp    8010592f <alltraps>
...
8010608f:	6a 46                	push   $0x46
  jmp alltraps
80106091:	e9 99 f8 ff ff       	jmp    8010592f <alltraps>
...
80106098:	6a 47                	push   $0x47
  jmp alltraps
8010609a:	e9 90 f8 ff ff       	jmp    8010592f <alltraps>
...
801060a1:	6a 48                	push   $0x48
  jmp alltraps
801060a3:	e9 87 f8 ff ff       	jmp    8010592f <alltraps>
...
801060aa:	6a 49                	push   $0x49
  jmp alltraps
801060ac:	e9 7e f8 ff ff       	jmp    8010592f <alltraps>
...
801060b3:	6a 4a                	push   $0x4a
  jmp alltraps
801060b5:	e9 75 f8 ff ff       	jmp    8010592f <alltraps>
...
801060bc:	6a 4b                	push   $0x4b
  jmp alltraps
801060be:	e9 6c f8 ff ff       	jmp    8010592f <alltraps>
...
801060c5:	6a 4c                	push   $0x4c
  jmp alltraps
801060c7:	e9 63 f8 ff ff       	jmp    8010592f <alltraps>
...
801060ce:	6a 4d                	push   $0x4d
  jmp alltraps
801060d0:	e9 5a f8 ff ff       	jmp    8010592f <alltraps>
...
801060d7:	6a 4e                	push   $0x4e
  jmp alltraps
801060d9:	e9 51 f8 ff ff       	jmp    8010592f <alltraps>
...
801060e0:	6a 4f                	push   $0x4f
  jmp alltraps
801060e2:	e9 48 f8 ff ff       	jmp    8010592f <alltraps>
...
801060e9:	6a 50                	push   $0x50
  jmp alltraps
801060eb:	e9 3f f8 ff ff       	jmp    8010592f <alltraps>
...
801060f2:	6a 51                	push   $0x51
  jmp alltraps
801060f4:	e9 36 f8 ff ff       	jmp    8010592f <alltraps>
...
801060fb:	6a 52                	push   $0x52
  jmp alltraps
801060fd:	e9 2d f8 ff ff       	jmp    8010592f <alltraps>
...
80106104:	6a 53                	push   $0x53
  jmp alltraps
80106106:	e9 24 f8 ff ff       	jmp    8010592f <alltraps>
...
8010610d:	6a 54                	push   $0x54
  jmp alltraps
8010610f:	e9 1b f8 ff ff       	jmp    8010592f <alltraps>
...
80106116:	6a 55                	push   $0x55
  jmp alltraps
80106118:	e9 12 f8 ff ff       	jmp    8010592f <alltraps>
...
8010611f:	6a 56                	push   $0x56
  jmp alltraps
80106121:	e9 09 f8 ff ff       	jmp    8010592f <alltraps>
...
80106128:	6a 57                	push   $0x57
  jmp alltraps
8010612a:	e9 00 f8 ff ff       	jmp    8010592f <alltraps>
...
80106131:	6a 58                	push   $0x58
  jmp alltraps
80106133:	e9 f7 f7 ff ff       	jmp    8010592f <alltraps>
...
8010613a:	6a 59                	push   $0x59
  jmp alltraps
8010613c:	e9 ee f7 ff ff       	jmp    8010592f <alltraps>
...
80106143:	6a 5a                	push   $0x5a
  jmp alltraps
80106145:	e9 e5 f7 ff ff       	jmp    8010592f <alltraps>
...
8010614c:	6a 5b                	push   $0x5b
  jmp alltraps
8010614e:	e9 dc f7 ff ff       	jmp    8010592f <alltraps>
...
80106155:	6a 5c                	push   $0x5c
  jmp alltraps
80106157:	e9 d3 f7 ff ff       	jmp    8010592f <alltraps>
...
8010615e:	6a 5d                	push   $0x5d
  jmp alltraps
80106160:	e9 ca f7 ff ff       	jmp    8010592f <alltraps>
...
80106167:	6a 5e                	push   $0x5e
  jmp alltraps
80106169:	e9 c1 f7 ff ff       	jmp    8010592f <alltraps>
...
80106170:	6a 5f                	push   $0x5f
  jmp alltraps
80106172:	e9 b8 f7 ff ff       	jmp    8010592f <alltraps>
...
80106179:	6a 60                	push   $0x60
  jmp alltraps
8010617b:	e9 af f7 ff ff       	jmp    8010592f <alltraps>
...
80106182:	6a 61                	push   $0x61
  jmp alltraps
80106184:	e9 a6 f7 ff ff       	jmp    8010592f <alltraps>
...
8010618b:	6a 62                	push   $0x62
  jmp alltraps
8010618d:	e9 9d f7 ff ff       	jmp    8010592f <alltraps>
...
80106194:	6a 63                	push   $0x63
  jmp alltraps
80106196:	e9 94 f7 ff ff       	jmp    8010592f <alltraps>
...
8010619d:	6a 64                	push   $0x64
  jmp alltraps
8010619f:	e9 8b f7 ff ff       	jmp    8010592f <alltraps>
...
801061a6:	6a 65                	push   $0x65
  jmp alltraps
801061a8:	e9 82 f7 ff ff       	jmp    8010592f <alltraps>
...
801061af:	6a 66                	push   $0x66
  jmp alltraps
801061b1:	e9 79 f7 ff ff       	jmp    8010592f <alltraps>
...
801061b8:	6a 67                	push   $0x67
  jmp alltraps
801061ba:	e9 70 f7 ff ff       	jmp    8010592f <alltraps>
...
801061c1:	6a 68                	push   $0x68
  jmp alltraps
801061c3:	e9 67 f7 ff ff       	jmp    8010592f <alltraps>
...
801061ca:	6a 69                	push   $0x69
  jmp alltraps
801061cc:	e9 5e f7 ff ff       	jmp    8010592f <alltraps>
...
801061d3:	6a 6a                	push   $0x6a
  jmp alltraps
801061d5:	e9 55 f7 ff ff       	jmp    8010592f <alltraps>
...
801061dc:	6a 6b                	push   $0x6b
  jmp alltraps
801061de:	e9 4c f7 ff ff       	jmp    8010592f <alltraps>
...
801061e5:	6a 6c                	push   $0x6c
  jmp alltraps
801061e7:	e9 43 f7 ff ff       	jmp    8010592f <alltraps>
...
801061ee:	6a 6d                	push   $0x6d
  jmp alltraps
801061f0:	e9 3a f7 ff ff       	jmp    8010592f <alltraps>
...
801061f7:	6a 6e                	push   $0x6e
  jmp alltraps
801061f9:	e9 31 f7 ff ff       	jmp    8010592f <alltraps>
...
80106200:	6a 6f                	push   $0x6f
  jmp alltraps
80106202:	e9 28 f7 ff ff       	jmp    8010592f <alltraps>
...
80106209:	6a 70                	push   $0x70
  jmp alltraps
8010620b:	e9 1f f7 ff ff       	jmp    8010592f <alltraps>
...
80106212:	6a 71                	push   $0x71
  jmp alltraps
80106214:	e9 16 f7 ff ff       	jmp    8010592f <alltraps>
...
8010621b:	6a 72                	push   $0x72
  jmp alltraps
8010621d:	e9 0d f7 ff ff       	jmp    8010592f <alltraps>
...
80106224:	6a 73                	push   $0x73
  jmp alltraps
80106226:	e9 04 f7 ff ff       	jmp    8010592f <alltraps>
...
8010622d:	6a 74                	push   $0x74
  jmp alltraps
8010622f:	e9 fb f6 ff ff       	jmp    8010592f <alltraps>
...
80106236:	6a 75                	push   $0x75
  jmp alltraps
80106238:	e9 f2 f6 ff ff       	jmp    8010592f <alltraps>
...
8010623f:	6a 76                	push   $0x76
  jmp alltraps
80106241:	e9 e9 f6 ff ff       	jmp    8010592f <alltraps>
...
80106248:	6a 77                	push   $0x77
  jmp alltraps
8010624a:	e9 e0 f6 ff ff       	jmp    8010592f <alltraps>
...
80106251:	6a 78                	push   $0x78
  jmp alltraps
80106253:	e9 d7 f6 ff ff       	jmp    8010592f <alltraps>
...
8010625a:	6a 79                	push   $0x79
  jmp alltraps
8010625c:	e9 ce f6 ff ff       	jmp    8010592f <alltraps>
...
80106263:	6a 7a                	push   $0x7a
  jmp alltraps
80106265:	e9 c5 f6 ff ff       	jmp    8010592f <alltraps>
...
80106275:	6a 7c                	push   $0x7c
  jmp alltraps
80106277:	e9 b3 f6 ff ff       	jmp    8010592f <alltraps>
...
8010627e:	6a 7d                	push   $0x7d
  jmp alltraps
80106280:	e9 aa f6 ff ff       	jmp    8010592f <alltraps>
...
80106287:	6a 7e                	push   $0x7e
  jmp alltraps
80106289:	e9 a1 f6 ff ff       	jmp    8010592f <alltraps>
...
8010685d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106862:	e9 c8 f0 ff ff       	jmp    8010592f <alltraps>
...
80106869:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010686e:	e9 bc f0 ff ff       	jmp    8010592f <alltraps>
...
80106875:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010687a:	e9 b0 f0 ff ff       	jmp    8010592f <alltraps>
...
80106881:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106886:	e9 a4 f0 ff ff       	jmp    8010592f <alltraps>
...
8010688d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106892:	e9 98 f0 ff ff       	jmp    8010592f <alltraps>
...
80106a2d:	68 58 7b 10 80       	push   $0x80107b58
...
80106c5b:	68 9d 7b 10 80       	push   $0x80107b9d
...
80106cc0:	68 b7 7b 10 80       	push   $0x80107bb7
...
80106d48:	68 58 7c 10 80       	push   $0x80107c58
...
80106de9:	68 d5 7b 10 80       	push   $0x80107bd5
...
80106e4b:	68 ed 7b 10 80       	push   $0x80107bed
...
80106ffc:	68 1a 7c 10 80       	push   $0x80107c1a
...
80107072:	68 24 7c 10 80       	push   $0x80107c24
...
80107147:	68 3e 7c 10 80       	push   $0x80107c3e
